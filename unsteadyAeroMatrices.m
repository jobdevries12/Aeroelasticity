...
%% Lag-States
W = 2*pi*rho_air*V^2*b.*momentArm*[psi1*eps1^2*V/b^2 -psi2*eps2^2*V/b^2 -psi1*eps1*V/b*(eps1*(1/2-a)-1) -psi2*eps2*V/b*(eps2*(1/2-a)-1) psi1*eps1*(eps1*V/b*T11/(2*pi) - T10/pi) psi2*eps2*(eps2*V/b*T11/(2*pi) - T10/pi)]
